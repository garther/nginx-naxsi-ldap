...
%define COMMON_CONFIGURE_ARGS $(echo "\
        ...
        --with-file-aio \
        --with-ipv6 \
	--add-module=%{_builddir}/%{name}-%{main_version}/naxsi/naxsi_src \
        --add-module=%{_builddir}/%{name}-%{main_version}/ldap \
...
%{__install} -m 644 -p %{_builddir}/%{name}-%{main_version}/naxsi/naxsi_config/naxsi_core.rules \
